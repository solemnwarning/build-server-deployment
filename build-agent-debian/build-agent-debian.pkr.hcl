...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo debootstrap --include=file,build-essential,cmake,gcovr,git,libcapstone-dev,libcapstone3,libglew-dev,libglew2.0,libgtk2.0-dev,libjansson-dev,libjansson4,liblua5.3-0,liblua5.3-dev,libopenal-dev,libsdl2-2.0-0,libsdl2-dev,libtemplate-perl,libunistring-dev,libunistring0,libwxgtk3.0-dev,lua5.3,lua-busted,xvfb,xauth --arch=i386 stretch /srv/chroot/stretch-i386/ http://cdn-aws.deb.debian.org/debian",
      ...
      "sudo debootstrap --include=file,build-essential,cmake,gcovr,git,libcapstone-dev,libcapstone3,libglew-dev,libglew2.0,libgtk2.0-dev,libjansson-dev,libjansson4,liblua5.3-0,liblua5.3-dev,libopenal-dev,libsdl2-2.0-0,libsdl2-dev,libtemplate-perl,libunistring-dev,libunistring0,libwxgtk3.0-dev,lua5.3,lua-busted,xvfb,xauth,mingw-w64,nasm --arch=amd64 stretch /srv/chroot/stretch-amd64/ http://cdn-aws.deb.debian.org/debian",
